    ...
    window.Framework7 = function (params) {
        ...
        app.initSwipePanels = function () {
            ...
            */
            ...
            function handleTouchMove(e) {
                ...
                var pageY = e.type === 'touchmove' ? e.targetTouches[0].pageY : e.pageY;
                if (typeof isScrolling === 'undefined') {
                    ///niko - fix vertical motions
                    //isScrolling = !!(isScrolling || Math.abs(pageY - touchesStart.y) > Math.abs(pageX - touchesStart.x));
                    isScrolling = !!(isScrolling || (Math.abs(pageY - touchesStart.y) > (Math.abs(pageX - touchesStart.x) - 1)));
                }
                if (isScrolling) {
                    isTouched = false;
                    return;
                ...
                if (!direction) {
                    ...
                    ///niko
                    ///define direction during moving
                    if(1){
                        if ($('.panel.active').length > 0) {
                            side = $('.panel.active').hasClass('panel-left') ? 'left' : 'right';
                        }
        ...
        ************   Swipeout Actions (Swipe to delete)   ************
        ...
        app.initSwipeout = function (swipeoutEl) {
            ...
            function handleTouchStart(e) {
                ...
                touchStartTime = (new Date()).getTime();
                ///niko
                //console.log(app.params.swipePanelActiveArea + " " + touchesStart.x);
                ///fix for left and right swipes panel with swipeOut items in listbox

                if(app.params.swipePanelActiveArea > touchesStart.x || touchesStart.x > window.innerWidth - app.params.swipePanelActiveArea){
                    isTouched = false;
                    return;
        ...
        ************   Smart Select   ************
        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
            ...
            function handleInputs(container) {
                ...
                container.on('change click', 'input[name="' + inputName + '"]', function () {
                    var input = this;
        ...
        ************   Ajax submit for forms   ************
        ...
        $(document).on('submit change', 'form.ajax-submit, form.ajax-submit-onchange', function (e) {
            ...
            var contentType = form.prop('enctype') || form.attr('enctype') || "application/x-www-form-urlencoded"; ;
            ...
            function createMethod(method) {
                $[method] = function (url, data, success, error) {
                    return $.ajax({
                        ...
                        error: typeof data === 'function' ? success : error, //niko
